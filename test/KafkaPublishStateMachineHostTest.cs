...
public class KafkaPublishStateMachineHostTest : IClassFixture<ServiceFixture>
{
    ...
    public KafkaPublishStateMachineHostTest(ITestOutputHelper testOutputHelper, ServiceFixture serviceFixture)
    {
