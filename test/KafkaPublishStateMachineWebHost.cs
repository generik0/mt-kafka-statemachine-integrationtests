...
public class KafkaPublishStateMachineWebHost : IClassFixture<WebHostFixture>
{
    ...
    public KafkaPublishStateMachineWebHost(ITestOutputHelper testOutputHelper, WebHostFixture webHostFixture)
    {
        webHostFixture.TestOutputHelper = testOutputHelper;
        _testOutputHelper = testOutputHelper;
        _webHostFixture = webHostFixture;
        webHostFixture.GetOrCreateServiceProvider();
        _harness = webHostFixture.ServiceProvider.GetTestHarness();
        _faker = new Faker();
    }
    ...
    {
        await using var scoped = _webHostFixture.ServiceProvider!.CreateAsyncScope();
